...
const PrivacyPolicy = () => {
  return (
    <CContainer>
      ...
      <p>
        Ubox built the Ubox app as a Free app. This SERVICE is provided by Ubox
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Ubox unless otherwise
      ...
      <p>
        ...
        but not limited to Msisdn. The information that we request will be
      ...
      <p>This policy is effective as of 2021-05-18</p>
      <p>
        <strong>Contact Us</strong>
      </p>
      <p>
        If you have any questions or suggestions about our Privacy Policy, do
        not hesitate to contact us at help@ubox.id.
      </p>
      <p>
